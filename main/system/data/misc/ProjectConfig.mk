...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = R27
MTK_BUILD_VERNO = E7_Blackview_20161122
...
CUSTOM_HAL_IMGSENSOR = gc8024mipi_raw gc2365_mipi_raw hi259_mipi_raw hi843b_mipi_raw
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = gc8024mipi_raw hi843b_mipi_raw
...
CUSTOM_HAL_SUB_IMGSENSOR = gc2365_mipi_raw hi259_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc8024mipi_raw gc2365_mipi_raw hi259_mipi_raw hi843b_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc8024mipi_raw hi843b_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc2365_mipi_raw hi259_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT1XX
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_MODEM = t637_hct6737m_65_m0-lwg_dsds_cotsx-_3m_gsm4p_w1_8_fdd1_3_7_8_20_skypa
...
#CREATE_PROJECT_INFO=20160408133517

########## add by MMI ############# 
HCT_LOCALIZATION_OVERLAY = zh-rCN
HCT_BUILD_PRODUCT_NAME = t637ae-jk-e7-63pu-hd-128g8g-bom124
HCT_PRODUCT_MODEL= E7
HCT_PRODUCT_BRAND= Blackview
HCT_PRODUCT_MANUFACTURER = Blackview
HCT_PRODUCT_NAME = E7

#add Theme and wallpaper
#HCT_LAUNCHER3 = yes
HCT_LAUNCHER3_MU = yes
#HCT_LEWA_LAUNCHER = yes
HCT_THEME_SHOW = yes
...
#add fingerprint of 368
HCT_SUPPORT_FINGERPRINT_GF368_GOODIX = yes
#xinwei
HCT_SUPPORT_FINGERPRINT_SUNWAVE = yes
HCT_REMOVE_IP_PREFIX_SUPPORT = yes
MTK_PHONE_NUMBER_GEODESCRIPTION = no
#browser not show page navigation
HCT_NO_BROWSER_NAVIGATION = yes
#show more when set ringtone
HCT_EXTRA_RINGTONE_SHOW_MORE_RINGTONES = yes
#modify animation
HCT_BOOTANIM = yes
HCT_SHUTANIM = yes
#ka dun 
HCT_LOW_RAM_OPTIMIZE = yes
#add apk
HCT_T637AE_JK_APK = yes
HCT_TORCH_SUPPORT = yes
HCT_SUPPORT_TODOS = yes
HCT_SUPPORT_VIDEOPLAYER = yes
#white list
HCT_WHITE_LIST = yes

HCT_GOOGLE_GMS_R3 = yes
HCT_PACKAGES_SUBSTITUTE = GoogleCamera:- GoogleHome:- GooglePinyinIME:- GoogleHindiIME:- KoreanIME:- DeskClockGoogle:- Music:- Wallet:- EditorsDocs:- EditorsSlides:- EditorsSheets:- Keep:- Bugle:- NewsWeather:- CloudPrint:- DMAgent:- Drive:- Music2:- Newsstand:- PlayGames:- PlusOne:- TagGoogle:- Videos:- Books:- Chrome:- Photos:- Hangouts:- YouTube:- BLEManager:- SetupWizard:- LatinImeGoogle:- CalendarGoogle:- IR_UeiRemoteControl:- IR_UeiSdkIrManager:- IR_UeiSdkSampleTest:- TouchPal:- Wo3G:- MultiCoreObserver:- Launcher3:- AndroidPay:- JapaneseIME:-
